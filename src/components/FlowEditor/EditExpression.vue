...
export default {
  ...
  computed: {
    showDlg: {
      get() {
        return this.manager.expression.ShowExpDlg;
      },
      set(data) {
        this.manager.expression.ShowExpDlg = data;
      },
    },
  },
  watch: {
  ...
  methods: {
    ...
    dlgOpen() {
      this.manager.SetSheetWindowName();

      this.SheetWindowName = this.manager.CurrentSheetWindowName;
      this.Expression = this.manager.expression.Expression;
      this.PsmExpression = this.manager.expression.PsmExpression;
      this.ParameterXml = this.manager.expression.ParameterXml;
      this.init();
    },
    async init() {
    ...
    async handleConfirm() {
      await this.handleValidateExpression();
